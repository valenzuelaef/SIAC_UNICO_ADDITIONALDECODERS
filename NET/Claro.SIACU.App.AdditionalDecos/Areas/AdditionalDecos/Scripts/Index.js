(function ($, undefined) {
    ...
    Form.prototype = {
        ...
        loadSettings: function (data) {
            ...
            that.AdditionalDecos.Configuration.Constants.Plataforma_Facturador = Session.SessionParams.DATACUSTOMER.objPostDataAccount.plataformaAT !== 'TOBE' ? 'BSCS7' : 'CBIO';
            if (that.AdditionalDecos.oRequest.strTechnology == "9") {
                that.AdditionalDecos.Configuration.Constants.Tipservicio = Session.SessionParams.DATACUSTOMER.objPostDataAccount.plataformaAT !== 'TOBE' ? '0061' : '0101';//AS IS - TO BE
            } else {
                that.AdditionalDecos.Configuration.Constants.Tipservicio = Session.SessionParams.DATACUSTOMER.objPostDataAccount.plataformaAT !== 'TOBE' ? '0061' : '0061';
            }
        ...
        addEquipment: function (strID) {
            ...
            if (arrEquipmentRemoveSelect.length > 0) {
                ...
                oEquipmentAdd.spcode = '';//that.AdditionalDecos.oRequest.arrEquipmentAdd.filter(function (x) { return x.LineID == oEquipmentAdd.LineID; })[0].spCode;//Ojo solo TOBE
            ...
            var servicios = [
                ...
                },
                {
                    ...
                    "parametros": [
                        ...
                        {
                            "parametro": "tipo",
                            "valor": that.AdditionalDecos.oRequest.strTechnology == '9' ? that.getSettingsSave('Tipo') : 'HFC' //Quitar al pasar la configuracion
                        },
                        {
                            "parametro": "clase",
                ...
                },
                {
                    ...
                    "parametros": [
                        ...
                        },
                        {
                            ...
                            "valor": that.AdditionalDecos.Data.CustomerInformation.ContactName //that.AdditionalDecos.Data.CustomerInformation.CustomerName
                        },
                        {
                        ...
                        {
                            "parametro": "inter7", //AD
                            "valor": that.AdditionalDecos.Data.Instalation.Direccion// that.AdditionalDecos.Data.Instalation.NotaDireccion//Session.SessionParams.DATACUSTOMER.OfficeAddress
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "valor": that.AdditionalDecos.Data.Instalation.NotaDireccion //Session.SessionParams.DATACUSTOMER.Address Session.SessionParams.DATACUSTOMER.OfficeAddress//
                        },
                        {
                            "parametro": "P_CITY",
                        ...
                        {
                            "parametro": "P_REASON",
                            "valor": that.AdditionalDecos.Data.CustomerInformation.CustomerName//Session.SessionParams.DATACUSTOMER.BusinessName
                        },
                        {
        ...
        InitialValidation: function () {
            ...
            if (!$.array.isEmptyOrNull(that.AdditionalDecos.Data.ValidarTransaccion)) {
                ...
                if (that.AdditionalDecos.Data.ValidarTransaccion.Codigo == "-1") {
